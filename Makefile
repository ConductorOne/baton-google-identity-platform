...
ifeq ($(GOOS),windows)
OUTPUT_PATH = ${BUILD_DIR}/baton-google-identity-platform.exe
else
OUTPUT_PATH = ${BUILD_DIR}/baton-google-identity-platform
endif
...
build: $(GENERATED_CONF)
	go build ${BUILD_TAGS} -o ${OUTPUT_PATH} ./cmd/baton-google-identity-platform
